...
class Player(pygame.sprite.Sprite):
    def __init__(self,pos):
        ...
        self.player_status = {'attack_1':False,'attack_combo':False,'attack_crouch':False,'crouch':False,'crouch_walk':False,'death':False,'fall':False,'hurt':False,'idle':True,'jump':False,'roll':False,'run':False,'slide':False,'wall_slide':False}
        self.health = 100
        self.stamina = 100
        self.gravity = 0.7
        self.jump_height = -14
    ...
    def import_player_assets(self):
        self.animations = {'attack_1':[],'attack_combo':[],'attack_crouch':[],'crouch':[],'crouch_walk':[],'death':[],'fall':[],'hurt':[],'idle':[],'jump':[],'roll':[],'run':[],'slide':[],'wall_slide':[]}
        
        for animation in self.animations.keys():
    
            self.default_path = 'C:/Users/chris/OneDrive/Desktop/Platform_Game/images/player/'
    ...
    def animate(self):
        if(self.facing_right == True):
            ...
            if self.player_status['attack_crouch'] == True and self.player_status['idle'] == False:
            ...
            if self.player_status['crouch'] == True and self.player_status['idle'] == False:
            ...
            if self.player_status['crouch_walk'] == True and self.player_status['idle'] == False:
            ...
            if self.player_status['fall'] == True and self.player_status['idle'] == False:
            ...
            if self.player_status['idle'] == True:
            ...
            if self.player_status['roll'] == True and self.player_status['idle'] == False:
            ...
            if self.player_status['run'] == True and self.player_status['idle'] == False:
            ...
            if self.player_status['slide'] == True and self.player_status['idle'] == False:
            
                self.frame_index += self.slide_frame_speed
                
                if int(self.frame_index) > len(self.animations['slide']) - 1:

                    self.frame_index = 0
                
                self.image = self.animations['slide'][int(self.frame_index)]
            ...
            if self.player_status['slide'] == True and self.player_status['idle'] == False:
                ...
                image = self.animations['slide'][int(self.frame_index)]
                flipped_image = pygame.transform.flip(image,True,False)     
                self.image = flipped_image
    ...
    def input(self):
        ...
        if keys[pygame.K_q] or keys[pygame.K_e] and self.on_ground:
        
            if keys[pygame.K_q]:
                
                self.player_status['slide'] = True
